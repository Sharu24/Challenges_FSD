...
var num = Number(rls.question("Enter a number to be rotated : "));
var rot = Number(rls.question("Enter the Number of bits to be rotated by : "));
var dir = rls.question("Enter the rotation direction : ");

var str = padNum(num.toString(2), 8, 0);
console.log(str);

var res = rotateBit(str, rot, dir);
console.log(res);
console.log(
  `Rotating ${num}, ${
    dir == "l" ? "left" : "right"
