...
var userInp = readlineSync.question("Please enter a String to Encrypt : ");
var key = readlineSync.question("Enter Key : ");

var encryptedStr = encrypt(userInp, key);
console.log("Out Encrypted String:", encryptedStr);
